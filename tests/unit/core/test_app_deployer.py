...
class TestAppDeployer:
    ...
    def mock_get_auth_token(self, mocker):
        yield mocker.patch(
            "griptape.cli.core.app_deployer.get_auth_token",
            return_value="1234d86fc71d72fe1ec1234567afaf98a8e442e4",
        )

    @pytest.fixture()
    def mock_requests_post(self, mocker):
        yield mocker.patch(
            "griptape.cli.core.app_deployer.requests.post",
    ...
    def test_deploy(self, mocker, mock_get_auth_token, mock_requests_post):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            assert kwargs.get("headers") == {
                "Authorization": f"Token {mock_get_auth_token.return_value}"
            }
